...
<p align="center">
  <img src="docs/images/showcase-product.jpg" width="32%" alt="Photorealistic product shot of a teal ceramic coffee mug" />
  <img src="docs/images/showcase-isometric.jpg" width="32%" alt="Isometric illustration of a developer workstation" />
  <img src="docs/images/showcase-sticker.png" width="32%" alt="Kawaii banana sticker wearing sunglasses" />
</p>
<p align="center"><em>All generated by this server — a photoreal product shot, an isometric illustration with legible text, and a vector sticker. No edits.</em></p>
...
>
> **Claude:** *calls `edit_image` with the previous `interaction_id` → `hero-v2.jpg`*
